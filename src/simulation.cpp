...
void CSimulation::initializeVectors()
{
    ...
    m_vCrossSectionBedSlope = vZeros;
    if (this->strGetDownwardEstuarineCondition() == "E")
    {
...
//===============================================================================================================================
void CSimulation::drySoil()
{
    for (int i, i < this->m_nCrossSectionsNumber, i++)
    {
        if (m_vCrossSectionArea[i] )
    }
}
